...
{	
	...
	public function uploadImage($filename, $filesize, $dir, $table){
		$fileinfo  = pathinfo($filename);
		$extension = pathinfo($filename, PATHINFO_EXTENSION);
		
		if($filesize <= 500000){
			$upload_path = $dir;
			$website = 'http://acharyahabba.in/habba18/';
			$upload_url = $website.'admin/'.$upload_path;

			$imageName = $this->getFileName($table);
